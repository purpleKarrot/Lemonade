...
namespace Git {
	...
	public class Remote {
		...
		*/
		...
		public Error download(TransferProgress progress);
	...
	[CCode(cname = "git_checkout_opts", default_value = "GIT_CHECKOUT_OPTS_INIT", has_destroy_function = false, has_type_id = false)]
	 ...
	 */
	[CCode(cname = "int", cprefix = "GIT_DIRECTION_", has_type_id = false)]
	...
	[CCode(cname = "int", cprefix = "GITERR_", has_type_id = false)]
	...
	public delegate int CredAcquire(out cred? cred, string url, string? username_from_url, uint allowed_types);
	[CCode(has_target = false, has_type_id = false)]
	...
	public delegate int TransferProgress(transfer_progress stats);
